                            ...
                            <div class="filter">
                                <div class="row form-group">
                                    ...
                                    <div class="filter custom-filter-bar do-not-display-filter-bar-for-small-device col-md-12">
                                        {!! Form::open(['route' => 'personal.searchbydistrict', 'method' => 'GET']) !!}
                                        <div class="row">
                                            <div class="col-lg-3 form-group">
                                                <label>District</label>
                                                {!! Form::select('district', $district, $_GET['district'] ?? null, ['class' => 'form-control search', 'placeholder' => 'Search by District']) !!}
                                            </div>
                                            <div class="col-lg-2">
                                                <p class="mt-4">
