...
<section class="padding-block">
    <div class="container-fluid">
        {{ Form::open(['route' => 'personal.store', 'enctype' => 'multipart/form-data']) }}
            <div class="row">
                            ...
                            <div class="card-body">
                                <div class="contact-form">
                                    <div class="row"><!-- main row open-->
                                        ...
                                        <div class="col-xs-8 col-md-8 form-group">
                                            {!! Form::text('full_name_np', null, ['class' => 'form-control']) !!}
                                        </div>
                                                </div>
                                        </div>
                                        ...
                                        <div class="col-xs-10 col-md-10 form-group">
                                            {!! Form::date('dob_en', null, ['class' => 'form-control flat', 'placeholder' => 'Pick a Date']) !!}
                                        </div>
                                        {!! Form::label('dob_np', 'DOB Nepali Date: <span class="required-field"></span>', ['class' => 'col-xs-2 col-md-2'], false); !!}
                                        <div class="col-xs-10 col-md-10 form-group">
                                            {!! Form::text('dob_np', null, ['class' => 'form-control nepali', 'placeholder' => 'Pick a Date', 'id' => 'nepali']) !!}
                                        </div>
                                        ...
                                        <div class="col-xs-10 col-md-10 form-group">
                                            {!! Form::select('gender', $gender, null, ['class' => 'form-control drop', 'placeholder' => 'Select gender']) !!}
                                        </div>
                                        {!! Form::label('religion', 'Religion: <span class="required-field"></span>', ['class' => 'col-xs-2 col-md-2'], false); !!}
                                        <div class="col-xs-10 col-md-10 form-group">
                                            {!! Form::select('religion', $religion, null, ['class' => 'form-control drop', 'placeholder' => 'Select religion']) !!}
                                        </div>
                                        {!! Form::label('group', 'Group: <span class="required-field"></span>', ['class' => 'col-xs-2 col-md-2'], false); !!}
                                        <div class="col-xs-10 col-md-10 form-group">
                                            {!! Form::select('group', $group, null, ['class' => 'form-control drop', 'placeholder' => 'Select group']) !!}
                                        </div>
                                        ...
                                        {!! Form::label('image', 'Image: <span class="required-field"></span>', ['class' => 'col-xs-2 col-md-2'], false); !!}
                                        <div class="col-xs-10 col-md-10 form-group">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="row">
                                                    <div class="col-xs-2 col-md-2 form-group">
                                                        {!! Form::select('temporary_pradesh', $province, null, ['class' => 'form-control drop', 'placeholder' => 'Pradesh']) !!}
                                                    </div>
                                                    <div class="col-xs-2 col-md-2 form-group">
                                                        {!! Form::select('temporary_district', $district, null, ['class' => 'form-control drop', 'placeholder' => 'District']) !!}
                                                    </div>
                                                    <div class="col-xs-3 col-md-3 form-group">
                                                        {!! Form::select('temporary_local_auth', $local_auth, null, ['class' => 'form-control drop', 'placeholder' => 'Local Auth']) !!}
                                                    </div>
                                                    <div class="col-xs-2 col-md-2 form-group">
                                                        {!! Form::text('temporary_ward', null, ['class' => 'form-control', 'placeholder' => 'Ward No.']) !!}
                                                    </div>
                                                    <div class="col-xs-2 col-md-2 form-group">
                                                        {!! Form::text('temporary_full_address', null, ['class' => 'form-control', 'placeholder' => 'Full Address']) !!}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row" style="margin-left:30px;">
                                            <div class="col-lg-12">
                                                <div class="row">
                                                    <div class="col-xs-2 col-md-2 form-group">
                                                        {!! Form::select('permanent_pradesh', $province, null, ['class' => 'form-control drop', 'placeholder' => 'Pradesh']) !!}
                                                    </div>
                                                    <div class="col-xs-2 col-md-2 form-group">
                                                        {!! Form::select('permanent_district', $district, null, ['class' => 'form-control drop', 'placeholder' => 'District']) !!}
                                                    </div>
                                                    <div class="col-xs-3 col-md-3 form-group">
                                                        {!! Form::select('permanent_local_auth', $local_auth, null, ['class' => 'form-control drop', 'placeholder' => 'Local Auth']) !!}
                                                    </div>
                                                    <div class="col-xs-2 col-md-2 form-group">
                                                        {!! Form::text('permanent_ward', null, ['class' => 'form-control', 'placeholder' => 'Ward No.']) !!}
                                                    </div>
                                                    <div class="col-xs-2 col-md-2 form-group">
                                                        {!! Form::text('permanent_full_address', null, ['class' => 'form-control', 'placeholder' => 'Full Address']) !!}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
